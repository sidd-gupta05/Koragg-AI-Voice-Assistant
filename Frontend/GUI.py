...
def QueryModifier(Query):
    ...
    question_words = ["how","who","where","when","why","which","whose","whom","can you","what's","where's","how's"]
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        max_gf_size__W  = 300
        max_gf_size__H = 400
        movie.setScaledSize(QSize(max_gf_size__H,max_gf_size__W))
    ...
    def toogle_icon(self, event= None):
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        max_gif_size_W = 1200  # New width
        max_gif_size_H = 800  # New height
